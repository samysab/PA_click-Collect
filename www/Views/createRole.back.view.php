         ...
         <div class="col-lg-6 col-md-6 col-sm-12 col">
             <div class="jumbotron">
                 <div class="form_align--top">
                     ...
                     <input class="input" type="text" name="name" placeholder="Admin" required="required">
                 </div>
             </div>
         </div>
     </div>
        ...
        <div class="row">
            <div class="col-lg-10 col-md-10 col-sm-12 col">
                <div class="jumbotron">
                    ...
                    <div class="mb-1 mt-1">
                        <input type="checkbox" id="role" name="roles" value="1" >
                        <label for="role">Gestion des rôles</label>
                    </div>

                    <div class="mb-1">
                        <input type="checkbox" id="user" name="users" value="1">
                        <label for="user">Gestion des utilisateurs</label>
                    </div>

                    <div class="mb-1">
                        <input type="checkbox" id="customer" name="customers" value="1">
                        <label for="customer">Gestion des clients</label>
                    </div>

                    <div class="mb-1">
                        <input type="checkbox" id="product" name="products" value="1">
                    ...
                    <div class="mb-1">
                        <input type="checkbox" id="order" name="orders" value="1">
                        <label for="order">Gestion des commandes</label>
                    </div>

                    <div class="mb-1">
                        <input type="checkbox" id="opinion" name="opinions" value="1">
                        <label for="opinion">Gestion des avis</label>
                    </div>

                    <div class="mb-1">
                        <input type="checkbox" id="page" name="pages" value="1">
